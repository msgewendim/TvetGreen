...
import { User, Settings, Award, Download, Clock, BookOpen, Star, ChevronRight, Mic, MicOff, Globe, Volume2, Smartphone, CircleHelp as HelpCircle, LogOut, CreditCard as Edit3, Calendar, Target, TrendingUp } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      {isListening && (
        <View style={styles.voiceInstructions}>
          <Text style={styles.voiceText}>🎤 Say "Show certificates" or "View achievements" or "Settings"</Text>
        </View>
      )}
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          <View style={styles.profileImageContainer}>
            <Image source={{ uri: userStats.profileImage }} style={styles.profileImage} />
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.userJoinDate}>Learning since {userStats.joinDate}</Text>
            
            <View style={styles.skillLevelBadge}>
              <Star size={16} color="#DAA520" strokeWidth={2} />
              <Text style={styles.skillLevelText}>{userStats.skillLevel} Learner</Text>
            </View>
          </View>
        </View>
          ...
          {recentCertificates.map((cert) => (
            <TouchableOpacity key={cert.id} style={styles.certificateCard}>
              ...
              <View style={styles.certificateInfo}>
                ...
                <Text style={styles.certificateInstructor}>by {cert.instructor}</Text>
                <Text style={styles.certificateDate}>Issued: {cert.issueDate}</Text>
                <Text style={styles.certificateId}>ID: {cert.credentialId}</Text>
              </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingSubtitle}>English, Amharic available</Text>
            </View>
            <ChevronRight size={20} color="#8B4513" strokeWidth={2} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingSubtitle}>Voice commands, audio quality</Text>
            </View>
            <ChevronRight size={20} color="#8B4513" strokeWidth={2} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingSubtitle}>WiFi only, quality settings</Text>
            </View>
            <ChevronRight size={20} color="#8B4513" strokeWidth={2} />
          </TouchableOpacity>
