  ...
  const handleDeleteCourse = (courseId: number, courseTitle: string) => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Delete', style: 'destructive', onPress: () => console.log('Delete course', courseId) },
      ]
    );
  };
    ...
    <View style={styles.container}>
      ...
      {isListening && (
        <View style={styles.voiceInstructions}>
          <Text style={styles.voiceText}>🎤 Say "Play course" or "Delete course" or "Check storage"</Text>
        </View>
      )}
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.storageContainer}>
          ...
          <View style={styles.storageInfo}>
            <Text style={styles.storageText}>{storageUsed} GB used of {storageTotal} GB</Text>
        ...
        <View style={styles.connectionStatus}>
          <View style={styles.connectionIndicator}>
            ...
            <Text style={styles.connectionText}>Offline Mode - Downloaded content available</Text>
          </View>
        </View>
            ...
            <View key={course.id} style={styles.courseCard}>
              <View style={styles.courseHeader}>
                <View style={styles.courseInfo}>
                  ...
                  <Text style={styles.courseSize}>{course.size} • Downloaded {course.downloadDate}</Text>
                </View>
                ...
                {download.progress > 0 ? (
                  <>
                    <View style={styles.downloadProgressBar}>
                      <View style={[styles.downloadProgressFill, { width: `${download.progress}%` }]} />
                    </View>
