...
import { ChevronRight, ArrowLeft, Volume2, CircleCheck as CheckCircle } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Select your preferred learning language</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          >
            <View style={styles.languageInfo}>
              ...
              <View style={styles.languageFeatures}>
                <View style={[
                  styles.featureBadge,
                  language.voiceSupport ? styles.featureBadgeActive : styles.featureBadgeInactive
                ]}>
                  <Volume2 size={14} color={language.voiceSupport ? "#32CD32" : "#A0A0A0"} strokeWidth={2} />
                  <Text style={[
                    styles.featureText,
                    language.voiceSupport ? styles.featureTextActive : styles.featureTextInactive
                  ]}>
                    Voice Support
                  </Text>
                </View>
        ...
        <View style={styles.noteContainer}>
          ...
          <Text style={styles.noteText}>
            ...
            Voice support helps with hands-free navigation and is especially 
            useful for learners who prefer audio guidance.
          </Text>
        </View>
      </ScrollView>
