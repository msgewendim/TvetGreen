...
export default function VideoPlayerScreen() {
	...
	const [duration, _setDuration] = useState(300); // 5 minutes example
	...
	const lessonProgress =
		(lessonData.lessonNumber / lessonData.totalLessons) * 100;
			...
			[
				{ text: "Review Again", style: "cancel" },
				{
					...
					onPress: () => {
						...
						router.push(
							`/video/${courseId}/${parseInt(lessonId as string, 10) + 1}`,
						);
					},
				},
			],
					...
					<View style={styles.settingsPanel}>
						<View style={styles.settingsContent}>
							...
							>
								...
								<View
									style={[styles.toggle, showSubtitles && styles.toggleActive]}
								>
									<View
										style={[
											styles.toggleThumb,
			...
			<View style={styles.lessonPanel}>
				...
				<View style={styles.navigationButtons}>
					...
					>
						<SkipBack
							size={20}
							color={lessonData.lessonNumber === 1 ? "#A0A0A0" : "#2F4F4F"}
							strokeWidth={2}
						/>
						<Text
							style={[
